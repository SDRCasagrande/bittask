...
.cet-grid{display:grid;grid-template-columns:1fr 1fr;gap:4px}
.brand-block{page-break-inside:avoid}
.brand-header{display:flex;justify-content:space-between;align-items:center;padding:2px 4px;background:linear-gradient(90deg,#e8f5e9,#fff);border-radius:3px 3px 0 0;border:1px solid #c8e6c9;border-bottom:none}
